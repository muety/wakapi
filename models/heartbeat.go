...
type Heartbeat struct {
	...
	UserID          string `json:"-" gorm:"not null; index:idx_time_user; index:idx_time_user_project_lang; index:idx_user_project"` // idx_user_project is for quickly fetching a user's project list (settings page)
	Entity          string `json:"entity" gorm:"not null"`
	Type            string `json:"type" gorm:"size:255"`
	Category        string `json:"category" gorm:"size:255"`
	Project         string `json:"project" gorm:"index:idx_project; index:idx_time_user_project_lang; index:idx_user_project"`
	Branch          string `json:"branch" gorm:"index:idx_branch"`
	Language        string `json:"language" gorm:"index:idx_language; index:idx_time_user_project_lang"`
	...
	Time             CustomTime `json:"time" gorm:"timeScale:3; index:idx_time; index:idx_time_user; index:idx_time_user_project_lang; not null" swaggertype:"primitive,number"`
