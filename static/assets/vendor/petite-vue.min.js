  ...
  PetiteVue = (function (e) {
    ...
    function Y(e = !1, t = !1) {
      return function (n, s, r) {
        ...
        if ("__v_raw" === s && r === (e ? (t ? oe : ie) : t ? re : se).get(n))
          return n;
        const i = p(n);
    ...
    const he = [],
      ...
      ye = ({ el: e, get: t, effect: n, arg: s, modifiers: r }) => {
        ...
        "class" === s && (e._class = e.className),
          n(() => {
            let n = t();
            if (s) (null == r ? void 0 : r.camel) && (s = $(s)), _e(e, s, n, i);
            else {
      ...
      _e = (e, t, s, r) => {
        if ("class" === t)
          e.setAttribute("class", o(e._class ? [e._class, s] : s) || "");
        else if ("style" === t) {
          s = n(s);
          const { style: t } = e;
          if (s)
        ...
        model: ({ el: e, exp: t, get: n, effect: s, modifiers: r }) => {
          ...
          if ("SELECT" === e.tagName) {
            ...
            ke(e, "compositionstart", Ce),
              ...
              ke(e, (null == r ? void 0 : r.lazy) ? "change" : "input", () => {
      ...
      Je = (e, t, n) => {
        ...
        g && (e.removeAttribute(m), "key" === m && (g = JSON.stringify(g))),
          (a = h.match(Ve)) &&
            ...
            a[2] && (u = a[2].trim())),
          (a = h.match(He)) &&
            ((l = a[1].split(",").map((e) => e.trim())), (d = "[" === h[0]));
        let b,
          y,
          _,
          x = !1;
    ...
    class rt {
      constructor(e, t, n = !1) {
        __publicField(this, "template"),
          ...
          n
            ? (this.ctx = t)
            : ((this.parentCtx = t), t.blocks.push(this), (this.ctx = tt(t))),
    ...
    let ct;
    return (
      (ct = document.currentScript) && ct.hasAttribute("init") && ot().mount(),
      (e.createApp = ot),
      (e.nextTick = me),
      (e.reactive = le),
