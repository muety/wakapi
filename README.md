...
| `security.session_key` /<br> `WAKAPI_SESSION_KEY`                                           | -                                                | Base64 encoded key (must decode to at least 32 bytes) used to encrypt sessions. If left empty, a random key is generated on startup.                                                                                                |
