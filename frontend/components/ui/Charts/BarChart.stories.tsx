...
export const BarChart = () => (
  <div className="flex flex-row gap-4 flex-wrap p-10">
    {[
      ...
      {
        title: "Minimal Highlighted Value",
        props: { minimalHeader: true, highlightedValue: 123 },
      },
      {
      ...
      },
      {
        ...
        props: {
          data: DATA.map((d) => ({ ...d, ram_usage: d.ram_usage + 0.1231233 })),
        },
      },
      ...
      {
        title: "Minimal Value format",
        props: { minimalHeader: true, format: "c" },
      },
